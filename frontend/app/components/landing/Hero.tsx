...
export default function Hero() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.to(".float-2", { y: -20, duration: 3, repeat: -1, yoyo: true, ease: "sine.inOut", delay: 0.3 });
      gsap.to(".float-3", { y: -12, duration: 2.2, repeat: -1, yoyo: true, ease: "sine.inOut", delay: 0.6 });
    }, containerRef);
  ...
  return (
    <section ref={containerRef} className="relative min-h-[110vh] luxury-gradient overflow-hidden px-4 md:px-8 pt-28 pb-20">
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div ref={titleRef} className="text-white space-y-8">
          ...
          <div className="overflow-hidden">
            <h1 className="font-serif text-[12vw] lg:text-[6.5vw] leading-[0.85] tracking-[-0.04em] font-light">
              ...
              <span className="hero-line block font-medium italic text-[#C5A880]">Dream</span>
          ...
          <p className="hero-sub max-w-[480px] text-white/60 text-[17px] leading-relaxed">
            Curated collection of 12,000+ luxury villas, penthouses and estates across 40 countries. Verified agents, instant tours, secure transactions.
          </p>

          <div className="flex flex-wrap gap-4 hero-cta">
            <Link href="/sign-in">
              <Button size="lg" variant="gold" className="group">Get Started <ArrowUpRight className="ml-2 w-5 h-5 group-hover:rotate-45 transition-transform" /></Button>
            </Link>
            <Button size="lg" variant="outline" className="!border-white/20 !text-white hover:!bg-white hover:!text-black"><Play className="mr-2 w-4 h-4" /> Watch Showreel</Button>
          </div>

          <div className="hero-cta grid grid-cols-3 gap-8 pt-8 border-t border-white/10 max-w-[420px]">
            <div><p className="text-3xl font-serif">12k+</p><p className="text-xs text-white/50 uppercase tracking-widest mt-1">Properties</p></div>
            <div><p className="text-3xl font-serif">340+</p><p className="text-xs text-white/50 uppercase tracking-widest mt-1">Agencies</p></div>
            <div><p className="text-3xl font-serif">98%</p><p className="text-xs text-white/50 uppercase tracking-widest mt-1">Satisfaction</p></div>
          </div>
        </div>
        ...
        <div ref={imagesRef} className="relative h-[700px] lg:h-[820px] w-full">
          ...
          <div className="parallax-img float-1 absolute left-[5%] top-[5%] w-[62%] h-[68%] rounded-[2.5rem] overflow-hidden shadow-2xl rotate-[-3deg] z-10">
            <img src={images[0]} alt="Luxury" className="w-full h-full object-cover" />
            ...
            <div className="absolute bottom-5 left-5 right-5 glass !bg-white/90 rounded-2xl p-4 flex justify-between items-center">
              <div><p className="font-serif font-medium">Seacliff Villa</p><p className="text-xs text-black/60">Malibu • $8.5M</p></div>
              <div className="w-10 h-10 rounded-full bg-black text-white grid place-items-center"><ArrowUpRight className="w-5 h-5" /></div>
            </div>
          </div>
          ...
          <div className="parallax-img absolute right-[8%] bottom-[8%] w-[44%] h-[42%] rounded-[2rem] overflow-hidden shadow-2xl rotate-[-2deg] z-30 border-[6px] border-white">
            ...
            <div className="absolute top-4 left-4 bg-white rounded-full px-3 py-1 text-[11px] font-semibold tracking-widest">FEATURED</div>
          </div>
          ...
          <div className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-28 h-28 rounded-full bg-[#C5A880] text-black grid place-items-center font-serif text-center leading-tight text-sm font-medium rotate-[-12deg] shadow-2xl z-30 hero-cta">
            <span>Trusted by<br/>2M+ Users</span>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 w-full border-t border-white/10 py-4 overflow-hidden">
        <div className="flex gap-12 animate-marquee whitespace-nowrap text-white/30 text-xs tracking-[0.3em] uppercase">
          <span>★ MANHATTAN ★ DUBAI ★ LONDON ★ BALI ★ MALIBU ★ SANTORINI ★ ASPEN ★</span>
          <span>★ MANHATTAN ★ DUBAI ★ LONDON ★ BALI ★ MALIBU ★ SANTORINI ★ ASPEN ★</span>
        </div>
      </div>
    </section>
